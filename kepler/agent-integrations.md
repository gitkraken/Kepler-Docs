...
|---|---|---|---|
| <img src="/wp-content/uploads/claude.png" width="16" height="16" style="vertical-align:middle; margin-right:6px;" alt=""> Claude Code | Anthropic's coding agent | Claude Code installed and configured locally | Supported |
| <img src="/wp-content/uploads/codex.png" width="16" height="16" style="vertical-align:middle; margin-right:6px;" alt=""> Codex CLI | OpenAI's coding agent | Codex CLI installed and configured locally | Supported |
| <img src="/wp-content/uploads/copilot.png" width="16" height="16" style="vertical-align:middle; margin-right:6px;" alt=""> Copilot CLI | GitHub's coding agent | Copilot CLI installed and authorized with a GitHub account | Supported |
| <img src="/wp-content/uploads/cursor.png" width="16" height="16" style="vertical-align:middle; margin-right:6px;" alt=""> Cursor | AI code editor with built-in agent | Cursor installed <!-- TODO: confirm with engineering: auth or API key requirements --> | Supported |
| <img src="/wp-content/uploads/opencode.png" width="16" height="16" style="vertical-align:middle; margin-right:6px;" alt=""> OpenCode | Open-source, model-agnostic coding agent | OpenCode installed; API key for your chosen model | Supported |

***

## <img src="/wp-content/uploads/claude.png" width="20" height="20" style="vertical-align:middle; margin-right:8px;" alt=""> Claude Code
...
## <img src="/wp-content/uploads/codex.png" width="20" height="20" style="vertical-align:middle; margin-right:8px;" alt=""> Codex CLI
...
## <img src="/wp-content/uploads/copilot.png" width="20" height="20" style="vertical-align:middle; margin-right:8px;" alt=""> Copilot CLI
...
## <img src="/wp-content/uploads/cursor.png" width="20" height="20" style="vertical-align:middle; margin-right:8px;" alt=""> Cursor
...
## <img src="/wp-content/uploads/opencode.png" width="20" height="20" style="vertical-align:middle; margin-right:8px;" alt=""> OpenCode
